...
import { listGrades, deleteGrade, updateGrade, addGrade } from '../assets/firebase/Grades';
...
export default function GradesManagement() {
  ...
  const handleChange = (e, index = null) => {
    ...
    if (index !== null) {
      ...
      updated[index].grades.finalAverage = calculateFinal(
        updated[index].examGrade,
        updated[index].assignmentGrade,
      );
      setGrades(updated);
    } else {
      const updated = {
  ...
  return (
    <Box sx={{ maxWidth: 960, mx: 'auto', mt: 4, px: 2 }}>
      ...
      {loading ? (
        ...
        <>
          <Typography variant="h6" sx={{ fontFamily: 'Assistant', mb: 2 }}>
            Add New Grade
          </Typography>
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 3 }}>
            ...
            <TextField
              label="Final Average"
              name="finalAverage"
              value={newGrade.grades.finalAverage}
              onChange={handleChange}
              disabled
            />
