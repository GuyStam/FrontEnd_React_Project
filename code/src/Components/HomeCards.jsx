    ...
    <Box sx={{ padding: 3 }}>
      <Grid container spacing={3} sx={{ mb: 4 }}>
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ padding: 3, display: "flex", flexDirection: "column", alignItems: "center", borderRadius: 2, boxShadow: 3, backgroundColor: "#7FC243" }}>
            <AssignmentIcon sx={{ fontSize: 40, color: "white" }} />
            <Typography variant="h6" sx={{ fontFamily: "Assistant", fontWeight: "bold", mb: 1, color: "white" }}>
